...
```{r question_4prep, include=FALSE}
...
This question aimed to assess opinions on which clinical dentistry skills should be required in DVM student training. Table 5.5 presents the Mann–Whitney U-testresults, summary statistics, effect sizes, and ranked-biserial correlation outputs.
...
This study had several limitations that should be considered when interpreting the results. The sample sizes were relatively small, particularly for the employer group, which had only 13 respondents after data cleaning. This limited the statistical power of the analyses and may reduce the generalizability of the findings. In addition, the uneven group sizes restricted the types of statistical tests that could be used and increased the potential for Type II errors, where real differences may not have been detected.
...
There were also geographic and institutional limitations. Most employer responses came from practices located on the U.S. East Coast, while educator responses were more geographically diverse and included some international institutions. This imbalance may limit the applicability of the findings to rural clinics or educational contexts outside of North America.

All data were self reported, which introduces additional concerns such as recall bias, social desirability bias, and variation in how participants interpret survey items. For example, the concept of “competency” may be understood differently across respondents, even if they selected similar response options on the Likert scale.

Missing data was another concern. Several participants did not complete the entire survey, and certain questions had high rates of missing or invalid responses. These gaps led to the exclusion of some data points and may have affected the robustness of the results for specific comparisons.

Lastly, the survey instruments were developed specifically for this project and were not subjected to formal pilot testing or validation. Although the questions were designed carefully and reviewed by subject matter experts, the lack of established reliability and validity measures may affect the accuracy and consistency of the data collected.
