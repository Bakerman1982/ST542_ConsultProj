...
# Perform Mann-Whitney U tests + effect size
...
# Optional: Create a map of human-friendly skill names
skill_labels <- c(
...
# Replace skill codes with readable labels
...
# 3. Run Mann-Whitney U test with effect sizes
...
mw_results %>%
  ...
  cols_label(
    ...
    median_educator = "Median (Educator)",
    median_employer = "Median (Employer)",
    n_educator = "N (Educator)",
    n_employer = "N (Employer)",
    P_Value = "P-Value",
    r_rb_fmt = "r_rb",
