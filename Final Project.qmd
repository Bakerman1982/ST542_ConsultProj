...
```{r Data_Desc_03, eval=TRUE, fig.align='center'}
...
# Clean educator dataset: remove metadata rows
Educator_Data_DESC03 <- Educator_Data[-c(1, 2), ]
view(Educator_Data_DESC03)
# Convert q27 to numeric
Educator_Data_DESC03$q27 <- as.numeric(Educator_Data_DESC03$q27)

# Plot
ggplot(Educator_Data_DESC03, aes(x = q27)) +
  geom_histogram(binwidth = 2, fill = "steelblue", color = "white") +
  labs(
    title = "Years Teaching DVM Students (Clinical Training)",
    x = "Years Teaching",
...
# Convert q41_1 to numeric
Educator_Data_DESC03$q41_1 <- as.numeric(Educator_Data_DESC03$q41_1)

# Plot
library(ggplot2)

Educator_Data_DESC03 %>%
  filter(!is.na(q41_1)) %>%
  ggplot(aes(x = q41_1)) +
  geom_histogram(binwidth = 2, fill = "steelblue", color = "black") +
  labs(
    title = "Number of Dental Procedures per Week",
    x = "Procedures per Week",
