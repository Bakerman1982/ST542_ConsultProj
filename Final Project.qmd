...
kable(mw_results_q4,
      format = "latex",
      booktabs = TRUE,
      caption = "Mann-Whitney U-Test Results for Q04 Competency Ratings",
      align = "c",
      row.names = FALSE) %>%
...
kable(mw_results_q3,
      caption = "Mann-Whitney U-Test Results for Q13/Q17 Beliefs about Pre-Clinical Dentistry Training",
      align = "c",
      row.names = FALSE,
      escape = FALSE,
