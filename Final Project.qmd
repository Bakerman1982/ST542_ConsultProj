...
```{r}
#| label: question_6a_updated_final
#| echo: false
#| warning: false
#| message: false
#| include: true
...
\newpage
```{r question_8a}
#| label: question_8a_updated_with_effect_size
#| echo: false
#| warning: false
#| message: false
#| include: true
...
Overall, while the effect sizes for several procedures suggest that educators may value certain clinical extraction skills and radiographic interpretation slightly more than employers, the differences were not statistically significant. The negligible effect sizes for basic procedures like polishing and oral exams indicate broad consensus between the two groups on those skills.
