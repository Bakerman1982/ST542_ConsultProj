...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, boxrule=0pt, sharp corners, interior hidden, borderline west={3pt}{0pt}{shadecolor}, breakable, enhanced]}{\end{tcolorbox}}\fi
...
{\centering \includegraphics{Final-Project_files/figure-pdf/Data_Desc_04-1.pdf}
...
{\centering \includegraphics{Final-Project_files/figure-pdf/Data_Desc_07-1.pdf}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.2055}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 10\tabcolsep) * \real{0.4082}}
...
{\centering \includegraphics{Final-Project_files/figure-pdf/s6_diverging_stacked_bar-1.pdf}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.5393}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.1685}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.1685}}
...
{\centering \includegraphics{Final-Project_files/figure-pdf/s8_diverging_stacked_bar_final-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{ref-avma2019}{}}%
