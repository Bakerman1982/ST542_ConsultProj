...
\begin{table}[!h]
\centering
\caption{\label{tab:full_q4_mannwhitney}Mann-Whitney U-Test Results for Competency Ratings}
\centering
...
\caption{\label{tab:question_3prep}Mann-Whitney U-Test Results for Pre-Clinical Dentistry Training}\\
\toprule
...
\begin{table}[!h]
\centering
\caption{\label{tab:question_4prep}Mann-Whitney U Test: Expected Dental Procedures by Group and Setting}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
...
\caption{\label{tab:6a_MannWhit_Table}Mann-Whitney U-Test Results for Clinical Instruction Formats}\\
\toprule
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{Median} & \multicolumn{1}{c}{N} & \multicolumn{1}{c}{ } & \multicolumn{1}{c}{Effect Size} & \multicolumn{1}{c}{ } \\
Skill & Med (Edu) & Med (Emp) & N (Edu / Emp) & P-Value & r\_rb & Interpretation\\
\midrule
...
\caption{\label{tab:8a_MannWhit_Table}Mann-Whitney U-Test Results for Clinical Procedures}\\
\toprule
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{Median} & \multicolumn{1}{c}{N} & \multicolumn{1}{c}{ } & \multicolumn{1}{c}{Effect Size} & \multicolumn{1}{c}{ } \\
Skill & Med (Edu) & Med (Emp) & N (Edu / Emp) & P-Value & r\_rb & Interpretation\\
\midrule
