...
\caption{\label{tab:unnamed-chunk-12}Mann-Whitney U-Test Results for Pre-Clinical Dentistry Training}\\
\toprule
...
vs.~14.3\%) than educators. These differences suggest varying
...
Figure 5.1 shows the percentages of each format selected and Table 5.2
...
selected this skill 82.1\% of the time, while employers selected this
skill only 30.8\% of the time. The resulting p-value was 0.00331.
...
the Mann--Whitney U-testresults, summary statistics, effect sizes, and
ranked-biserial correlation outputs.
...
Note that this exception was the only row that report fewer responses
...
ability to interpret radiographs. Although these differences were not
...
beliefs about dental competenciesn but key perception gaps remain that
may influence workforce readiness.

First, while both groups generally agreed on the importance of dental
training and reported similar expectations about preclinical and
...
group sizes restricted the types of statistical tests that could be used
and increased the potential for Type II errors, where real differences
...
educator responses were more geographically diverse and included some
international institutions. This imbalance may limit the applicability
of the findings to rural clinics or educational contexts outside of
North America.

All data were self reported, which introduces additional concerns such
as recall bias, social desirability bias, and variation in how
participants interpret survey items. For example, the concept of
``competency'' may be understood differently across respondents, even if
they selected similar response options on the Likert scale.

Missing data was another concern. Several participants did not complete
the entire survey, and certain questions had high rates of missing or
invalid responses. These gaps led to the exclusion of some data points
and may have affected the robustness of the results for specific
comparisons.

Lastly, the survey instruments were developed specifically for this
project and were not subjected to formal pilot testing or validation.
Although the questions were designed carefully and reviewed by subject
matter experts, the lack of established reliability and validity
measures may affect the accuracy and consistency of the data collected.
