...
\begin{longtable}[t]{>{\centering\arraybackslash}p{1.6in}>{\centering\arraybackslash}p{0.6in}>{\centering\arraybackslash}p{0.6in}>{\centering\arraybackslash}p{0.8in}>{\centering\arraybackslash}p{0.75in}>{\centering\arraybackslash}p{0.75in}>{\centering\arraybackslash}p{1.3in}}
...
\begin{longtable}[t]{>{\centering\arraybackslash}p{1.6in}>{\centering\arraybackslash}p{0.6in}>{\centering\arraybackslash}p{0.6in}>{\centering\arraybackslash}p{0.8in}>{\centering\arraybackslash}p{0.75in}>{\centering\arraybackslash}p{0.75in}>{\centering\arraybackslash}p{1.3in}}
\caption{\label{tab:question_3}Mann-Whitney U-Test Results for Q13/Q17 Beliefs about Pre-Clinical Dentistry Training}\\
\toprule
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{Median} & \multicolumn{1}{c}{N} & \multicolumn{1}{c}{ } & \multicolumn{1}{c}{Effect Size} & \multicolumn{1}{c}{ } \\
Skill & Med (Edu) & Med (Emp) & N (Edu / Emp) & P-Value & r\_rb & Interpretation\\
\midrule
...
\toprule
Clinical Setting & Median (Educator) & Median (Employer) & N (Educator) & N (Employer) & P-Value & r\_rb & Effect Size Interpretation \\ 
