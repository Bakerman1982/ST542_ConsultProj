...
\pandocbounded{\includegraphics[keepaspectratio]{Final-Project_files/figure-pdf/question_5a-1.pdf}}

The table below shows the percentages of each format selected (as seen
in the bar graph above) and the p-value associated with performing
Fisher's Exact Test on each format.
...
*Don't know whether to talk about ``none of the above'' being
significant.
...
\toprule\noalign{}
Format & \% of Educators & \% of Employers & P-value \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
Didactic & 53.3 & 61.5 & 0.743000 \\
Simulation & 16.7 & 30.8 & 0.417000 \\
Wet Lab & 73.3 & 46.2 & 0.162000 \\
Live Patient & 93.3 & 38.5 & 0.000303 \\
None of These & 0.0 & 23.1 & 0.023200 \\
\end{longtable}
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.2250}}
  >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1625}}
  >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1125}}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{Final-Project_files/figure-pdf/question_6a, -1.pdf}}
\end{center}
...
\pandocbounded{\includegraphics[keepaspectratio]{Final-Project_files/figure-pdf/unnamed-chunk-7-1.pdf}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.1744}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.1744}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.0930}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Skill
